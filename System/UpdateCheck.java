...
public class UpdateCheck extends JFrame implements ActionListener{
  ...
  public void actionPerformed(ActionEvent ae) {
    if(ae.getSource() == check){
      ...
      String query = "select * from customer where dnumber = '"+id+"'";
      ...
      try{
        ...
        while(rs2.next()){
          ...
          int amountToPay = Integer.parseInt(price) - Integer.parseInt(tfpaid.getText());
          tfpending.setText(""+amountToPay);
        }
      }catch(Exception e){
        e.printStackTrace();
      }
      ...
      try{
        Conn c = new Conn();
        c.s.executeUpdate("update customer set room = '"+room+"',cname = '"+name+"',checkintime = '"+checkin+"',deposit = '"+deposit+"' where dnumber = '"+number+"'");
